...
const N = s("HTMLFormElement"),
  ...
  P = {
    DIGIT: "0123456789",
    ALPHA: x,
    ALPHA_DIGIT: x + x.toUpperCase() + "0123456789"
  };
const U = {
  isArray: a,
  isArrayBuffer: u,
...
}), Object.defineProperties(_, B), Object.defineProperty(F, "isAxiosError", {
  value: !0
}), _.from = (e, t, n, r, o, s) => {
  const i = Object.create(F);
  return U.toFlatObject(e, i, function (e) {
    return e !== Error.prototype;
  }, e => "isAxiosError" !== e), _.call(i, e.message, t, n, r, o), i.cause = e, i.name = e.name, s && Object.assign(i, s), i;
};
function L(e) {
...
function I(e, t, n) {
  ...
  function c(e) {
    ...
    if (!a && U.isBlob(e)) throw new _("Blob is not supported. Use a Buffer instead.");
    return U.isArrayBuffer(e) || U.isTypedArray(e) ? a && "function" == typeof Blob ? new Blob([e]) : Buffer.from(e) : e;
  }
  function u(e, n, o) {
    let a = e;
    if (e && !o && "object" == typeof e) if (U.endsWith(n, "{}")) n = r ? n : n.slice(0, -2), e = JSON.stringify(e);else if (U.isArray(e) && function (e) {
      return U.isArray(e) && !e.some(L);
    }(e) || (U.isFileList(e) || U.endsWith(n, "[]")) && (a = U.toArray(e))) return n = D(n), a.forEach(function (e, r) {
      !U.isUndefined(e) && null !== e && t.append(!0 === i ? k([n], r, s) : null === i ? n : n + "[]", c(e));
    }), !1;
    return !!L(e) || (t.append(k(o, n, s), c(e)), !1);
  }
  const l = [],
    f = Object.assign(q, {
      defaultVisitor: u,
  ...
  return function e(n, r) {
    if (!U.isUndefined(n)) {
      ...
      l.push(n), U.forEach(n, function (n, s) {
...
function V(e, t, n) {
  ...
  const r = n && n.encode || J,
    o = n && n.serialize;
  let s;
  if (s = o ? o(t, n) : U.isURLSearchParams(t) ? t.toString() : new z(t, n).toString(r), s) {
    const t = e.indexOf("#");
...
function $(e) {
  function t(e, n, r, o) {
    ...
    const i = Number.isFinite(+s),
      a = o >= e.length;
    if (s = !s && U.isArray(r) ? r.length : s, a) return U.hasOwnProp(r, s) ? r[s] = [r[s], n] : r[s] = n, !i;
...
const Q = {
  ...
  transformRequest: [function (e, t) {
    ...
    if (U.isFormData(e)) return r && r ? JSON.stringify($(e)) : e;
    ...
    if (o) {
      if (n.indexOf("application/x-www-form-urlencoded") > -1) return function (e, t) {
        return I(e, new G.classes.URLSearchParams(), Object.assign({
  ...
  transformResponse: [function (e) {
    const t = this.transitional || Q.transitional,
...
U.forEach(["delete", "get", "head"], function (e) {
  ...
  Q.headers[e] = U.merge(X);
});
const Z = Q,
  Y = U.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
  ee = Symbol("internals");
function te(e) {
  return e && String(e).trim().toLowerCase();
}
function ne(e) {
  return !1 === e || null == e ? e : U.isArray(e) ? e.map(ne) : String(e);
}
function re(e, t, n, r, o) {
  return U.isFunction(r) ? r.call(this, t, n) : (o && (t = n), U.isString(t) ? U.isString(r) ? -1 !== t.indexOf(r) : U.isRegExp(r) ? r.test(t) : void 0 : void 0);
}
class oe {
  constructor(e) {
    e && this.set(e);
  ...
  set(e, t, n) {
    ...
    function o(e, t, n) {
      ...
      (!s || void 0 === r[s] || !0 === n || void 0 === n && !1 !== r[s]) && (r[s || t] = ne(e));
    }
    const s = (e, t) => U.forEach(e, (e, n) => o(e, n, t));
    return U.isPlainObject(e) || e instanceof this.constructor ? s(e, t) : U.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z]+$/.test(e.trim()) ? s((e => {
      const t = {};
      let n, r, o;
      return e && e.split("\n").forEach(function (e) {
        o = e.indexOf(":"), n = e.substring(0, o).trim().toLowerCase(), r = e.substring(o + 1).trim(), !n || t[n] && Y[n] || ("set-cookie" === n ? t[n] ? t[n].push(r) : t[n] = [r] : t[n] = t[n] ? t[n] + ", " + r : r);
      }), t;
  ...
  normalize(e) {
    ...
    return U.forEach(this, (r, o) => {
      ...
      if (s) return t[s] = ne(r), void delete t[o];
      const i = e ? function (e) {
        return e.trim().toLowerCase().replace(/([a-z\d])(\w*)/g, (e, t, n) => t.toUpperCase() + n);
      }(o) : String(o).trim();
      i !== o && delete t[o], t[i] = ne(r), n[i] = !0;
    }), this;
  }
  concat(...e) {
...
oe.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent", "Authorization"]), U.freezeMethods(oe.prototype), U.freezeMethods(oe);
const se = oe;
function ie(e, t) {
  const n = this || Z,
    r = t || n,
...
const ue = G.isStandardBrowserEnv ? {
...
const fe = G.isStandardBrowserEnv ? function () {
...
const pe = {
  ...
  xhr: "undefined" != typeof XMLHttpRequest && function (e) {
    return new Promise(function (t, n) {
      ...
      U.isFormData(r) && (G.isStandardBrowserEnv || G.isStandardBrowserWebWorkerEnv) && o.setContentType(!1);
      ...
      if (c.open(e.method.toUpperCase(), V(u, e.params, e.paramsSerializer), !0), c.timeout = e.timeout, "onloadend" in c ? c.onloadend = l : c.onreadystatechange = function () {
        ...
        const t = (e.withCredentials || fe(u)) && e.xsrfCookieName && ue.read(e.xsrfCookieName);
        t && o.set(e.xsrfHeaderName, t);
      }
      void 0 === r && o.setContentType(null), "setRequestHeader" in c && U.forEach(o.toJSON(), function (e, t) {
        c.setRequestHeader(t, e);
      }), U.isUndefined(e.withCredentials) || (c.withCredentials = !!e.withCredentials), s && "json" !== s && (c.responseType = e.responseType), "function" == typeof e.onDownloadProgress && c.addEventListener("progress", de(e.onDownloadProgress, !0)), "function" == typeof e.onUploadProgress && c.upload && c.upload.addEventListener("progress", de(e.onUploadProgress)), (e.cancelToken || e.signal) && (i = t => {
        c && (n(!t || t.type ? new ce(null, e, c) : t), c.abort(), c = null);
      }, e.cancelToken && e.cancelToken.subscribe(i), e.signal && (e.signal.aborted ? i() : e.signal.addEventListener("abort", i)));
      const f = function (e) {
        const t = /^([-+\w]{1,25})(:?\/\/|:)/.exec(e);
        return t && t[1] || "";
      }(u);
      f && -1 === G.protocols.indexOf(f) ? n(new _("Unsupported protocol " + f + ":", _.ERR_BAD_REQUEST, e)) : c.send(r || null);
    });
  }
};
U.forEach(pe, (e, t) => {
...
const he = e => {
  ...
  let n, r;
  for (let o = 0; o < t && (n = e[o], !(r = U.isString(n) ? pe[n.toLowerCase()] : n)); o++);
  if (!r) {
    if (!1 === r) throw new _(`Adapter ${n} is not supported by the environment`, "ERR_NOT_SUPPORT");
...
function ye(e) {
  me(e), e.headers = se.from(e.headers), e.data = ie.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1);
  return he(e.adapter || Z.adapter)(e).then(function (t) {
    return me(e), t.data = ie.call(e, e.transformResponse, t), t.headers = se.from(t.headers), t;
  }, function (t) {
    return ae(t) || (me(e), t && t.response && (t.response.data = ie.call(e, e.transformResponse, t.response), t.response.headers = se.from(t.response.headers))), Promise.reject(t);
  });
}
const ge = e => e instanceof se ? e.toJSON() : e;
function be(e, t) {
  t = t || {};
  const n = {};
  function r(e, t, n) {
...
Ee.transitional = function (e, t, n) {
  ...
  return (n, o, s) => {
    ...
    return t && !we[o] && (we[o] = !0, console.warn(r(o, " has been deprecated since v" + t + " and will be removed in the near future"))), !e || e(n, o, s);
  };
};
const Oe = {
    assertOptions: function (e, t, n) {
      ...
      for (; o-- > 0;) {
        ...
        if (i) {
          const t = e[s],
            n = void 0 === t || i(t, s, e);
          if (!0 !== n) throw new _("option " + s + " must be " + n, _.ERR_BAD_OPTION_VALUE);
        } else if (!0 !== n) throw new _("Unknown option " + s, _.ERR_BAD_OPTION);
      }
    },
    validators: Ee
  },
...
class Re {
  ...
  request(e, t) {
    ...
    }, !1), void 0 !== r && Oe.assertOptions(r, {
      encode: Se.function,
      serialize: Se.function
    }, !0), t.method = (t.method || this.defaults.method || "get").toLowerCase(), s = o && U.merge(o.common, o[t.method]), s && U.forEach(["delete", "get", "head", "post", "put", "patch", "common"], e => {
      delete o[e];
  ...
  getUri(e) {
    return V(le((e = be(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
  }
}
...
const ve = function t(n) {
  const r = new Ae(n),
    o = e(Ae.prototype.request, r);
  return U.extend(o, Ae.prototype, r, {
    allOwnKeys: !0
  }), U.extend(o, r, null, {
    allOwnKeys: !0
  }), o.create = function (e) {
...
ve.Axios = Ae, ve.CanceledError = ce, ve.CancelToken = Ne, ve.isCancel = ae, ve.VERSION = "1.3.4", ve.toFormData = I, ve.AxiosError = _, ve.Cancel = ve.CanceledError, ve.all = function (e) {
...
}, ve.mergeConfig = be, ve.AxiosHeaders = se, ve.formToJSON = e => $(U.isHTMLForm(e) ? new FormData(e) : e), ve.HttpStatusCode = je, ve.default = ve;
const xe = ve,
  {
    Axios: Pe,
    AxiosError: Ue,
...
export { Pe as Axios, Ue as AxiosError, ze as AxiosHeaders, ke as Cancel, Be as CancelToken, _e as CanceledError, He as HttpStatusCode, Le as VERSION, De as all, xe as default, Je as formToJSON, qe as isAxiosError, Fe as isCancel, Ve as mergeConfig, Ie as spread, Me as toFormData };