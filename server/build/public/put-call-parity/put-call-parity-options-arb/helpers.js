...
const constructDeribitExpiry = deltaExpiry => {
...
let deribitData = [];
const extractDeribitItems = (deribitData, deribitEqv => {
...
export const combineDeltaData = (deltaCalls, deltaPuts) => {
  let data = deltaCalls;
  data = [...data, ...deltaPuts];
  return data;
};
...
export const combineDerbibitData = (deribitBTC, deribitETH) => {
  let data = deribitBTC;
...
export const structureData = (deltaData, deribitData) => {
  const resObjArr = [];
