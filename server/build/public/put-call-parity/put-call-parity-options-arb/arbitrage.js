import { MIN_ARB_RATE } from "./constants.mjs";

// Find arbitrage opportunities
export const findArbitrage = data => {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    for (let j = 0; j < data.length; j++) {
      ...
      if (checkedSymbols.includes(item1.deltaSymbol) || checkedSymbols.includes(item2.deltaSymbol)) {
        continue;
      }
