...
const Hero = () => {
  return (
    <section className="mb-30">
      <div className="px-6 w-md flex flex-wrap items-center justify-between">
          ...
          <div className="grid lg:grid-cols-2 gap-12 flex items-center">
            <div className="mt-4 lg:mt-0">
              <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">
                The Simplest Crypto <br />
                <span className="text-blue-600">Arbitrage Finder</span>
              </h1>
              <a
            ...
            <div className="mb-12 lg:mb-0">
              <img src={cash} className="w-full rounded-lg shadow-lg" alt="" />
            </div>
          </div>
        </div>
      </div>
